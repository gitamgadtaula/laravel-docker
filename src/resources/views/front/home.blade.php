            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="product-item">
                        <a href="{{$tourDetailLink}}"> @if(isset($popular->photos[0]))
                            <img width="200" src="{{ asset('storage/'.$popular->photos[0]->filename ) }}" height="247">
                            @else
                            <img src="holder.js/200x123">
                            @endif</a>
                        <div class="down-content">
                            <a href="package-details.html">
                                <h4> {{str_limit($popular->name, 30)}}</h4>
                            </a>

                            <h6>$300 - $400</h6>

                            <p style="min-height:5rem;max-height:5rem;overflow:scroll">{{$popular->description}}</p>
